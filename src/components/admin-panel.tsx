    ...
    return (
      <Shell>
        <div className="app-card mx-auto w-full max-w-md p-6">
          <div className="mb-6 inline-flex rounded-lg bg-[var(--accent-soft)] p-3 text-[var(--accent)]">
  ...
  return (
    <Shell>
      <div className="app-card mx-auto w-full max-w-6xl space-y-6 p-6">
        ...
        <section className="section-card grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
      ...
      {isHistoryOpen && selectedClient ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4 py-6">
          <div className="w-full max-w-4xl rounded-xl border border-[var(--border)] bg-white p-5 shadow-2xl">
